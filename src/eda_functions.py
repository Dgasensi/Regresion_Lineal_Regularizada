...
def df_info(df):
    ...
    print(f' Hay {df_info["nulls"].sum()} valores nulos en el dataframe')
...
# Me ha costado la vida, pero he creado esta funcion para hacer target encoding en el futuro facilmente respecto a la media
